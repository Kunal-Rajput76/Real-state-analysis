...
# question 2: which locality has the highest number of flats listed?
locality_counts = df['locality'].value_counts()
highest_locality = locality_counts.idxmax()
print(f"The locality with the highest number of flats listed is {highest_locality} with {locality_counts[highest_locality]} flats.")