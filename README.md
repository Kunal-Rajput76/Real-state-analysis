...
This project analyzes a Gurgaon real estate dataset using Python to discover valuable insights about property prices, localities, builders, property types, and RERA approvals.

The project focuses on data cleaning, exploratory data analysis (EDA), data visualization, and answering business-related questions using statistical analysis.
...
```bash
git clone https://github.com/Kunal-Rajput76/Real-state-analysis.git
```

### 2. Navigate to the Project Folder

```bash
cd Real-state-analysis
```
...
Place the `data.csv` file inside the project folder.
...
* The most expensive properties in Gurgaon.
* Property price differences across localities.
* Pricing differences between RERA-approved and non-approved properties.
* Premium builders and property types.
* The relationship between property area and pricing.
* Property pricing trends using data visualization.
...
🔗 **GitHub:** (https://github.com/Kunal-Rajput76)
